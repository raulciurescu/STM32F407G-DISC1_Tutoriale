...
int main(void)
{
  ...
  //TIM1 ->CCR1 = 10;     // asta o sa fie exact cat e pwm-ul daca punem la configurare counter periodul pe 100-1 pentru ca formula e (CCR1/1000)*100
...
//  pwmData[3] = 40;
//  pwmData[4] = 50;
//  pwmData[5] = 60;                            /// asta e pentru generare de semnal cu pwm in crestere
//  pwmData[6] = 70;
//  pwmData[7] = 80;
//  pwmData[8] = 90;
//  pwmData[9] = 100;
